...
import {
  Box, Divider, ListSubheader, Typography,
} from '@mui/material';
...
export function HelpDrawer({
  ...
  return (
    <Drawer anchor="right" open={isOpen} onClose={() => setDrawerClose(false)}>
      <Box
        sx={{ width: 600 }}
        role="presentation"
      >
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <List>
              ...
              <ListItem>
                - Dla imprez, które mogą się odbywać wielokrotnie w ciągu roku w skali hufca, stosuje się kod w konstrukcji:
                [prefix]-[sufix]
